...
CAMINHO_IW28 = os.path.join(BASE_DIR, "data", "IW28.xlsx")
CAMINHO_IW47 = os.path.join(BASE_DIR, "data", "IW47.xlsx")
CAMINHO_IW38 = os.path.join(BASE_DIR, "data", "IW38.xlsx")
CAMINHO_SPLAN = os.path.join(BASE_DIR, "data", "splan.xlsx")
